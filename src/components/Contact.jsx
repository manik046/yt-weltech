...
const Contact = () => {
  return (
    <div name='contact' className='w-full md:h-screen bg-gradient-to-b from-cyan-900 to-cyan-700 text-white'>
        <div className='flex flex-col justify-center max-w-screen-lg mx-auto h-full'>
            ...
            <div className='flex justify-center items-center'>
                <form action='' className='flex flex-col w-full md:w-1/2'>
                    ...
                    className='my-2 p-2 bg-transparent border-2 rounded-md text-black focus:outline-none'
                    ></textarea>
                    <button className='text-white bg-gradient-to-r from-cyan-950 to-cyan-500
