...
const Clients = () => {
  ...
  return (
    <div
      name="clients"
      className="w-full md:h-screen bg-gradient-to-b from-cyan-900 to-cyan-700"
    >
      <div className="max-w-screen-lg text-white w-full h-full flex flex-col mx-auto justify-center">
        <div>
          ...
          <p className="py-6">See our Clients List</p>
        </div>
        <div
          className="w-full grid grid-cols-2 sm:grid-cols-3 gap-8 text-center py-8 
                                                px-12 sm:px-0"
        >
