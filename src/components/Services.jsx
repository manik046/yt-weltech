                        ...
                        service.map(({ id, src, product}) => (
                            <div key={id} className='shadow-md shadow-gray-600 rounded-lg '>
                                ...
                                <div className='flex justify-center items-center'>
                                    <button className='w-1/2 py-1 m-1 hover:scale-110 duration-300'>{product}</button>
                                    <button className='w-1/2 py-1 m-1 hover:scale-110 duration-300'>Details</button>
                                </div>
                            </div>
